        ...
        <table className="table w-full">
          ...
          <tbody>
            ...
            <tr>
              <td>Status</td>
              <td>
                <div className="badge badge-info p-4 text-sm font-semibold">
                  {application.status === Status.ELIGIBLE
                    ? Status.REVIEW
                    : application.status}
                </div>
                <Field as="select" name="applicationStatus">
                  <option value="red">ELIGIBLE</option>
                  <option value="green">APPROVED</option>
                  <option value="blue">REJECTED</option>
                </Field>
              </td>
            </tr>
            <tr>
            ...
            <tr>
              <td>Student Logs</td>
              <td>
                <Link className="link link-primary" href={"../adminLogs"}>
                  View
                </Link>
              </td>
            </tr>
