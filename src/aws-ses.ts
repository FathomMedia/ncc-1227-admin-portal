...
export const sendApprovalMail = async (userEmail: string, userName: string) => {
  try {
    const response = await transporter.sendMail({
      ...
      <body min-height='100vh' width="400px"
          ...
          <center style="background-color: #f1f1f1;">
              ...
              <div style="max-width: 600px; margin: 0 auto;" class="email-container">
                  <table style="width: 500px; text-align: center;" cellpadding="8">
                      <tbody>
                          <tr>
                              <br />
                              <td>
                                  <img className="" src="${logo}" alt="logo" width='400' height='100' />
                              </td>
                          </tr>
                          <tr>
                              <td style="text-align: center; margin-bottom: 2rem;">
                                  ...
                                  applying to [insert name of service here]. We have given
                                 a careful consideration to your application.<br /><br /></p>

                                  <p style="color: #243746; font-family: inter;">We are pleased
                                      to
                                      inform you
                                      that your application
                                      has been approved.<br /><br /></p>
                                  <p style="color: #243746; font-family: inter;">
                                      For more information on what to do next, follow the link below: <br /> [insert link here idk lmao]
                                      <br /><br />
                                  </p>
